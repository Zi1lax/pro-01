...
class Admin extends CI_Controller {
	...
	{
		$data['query']=$this->admin_model->list_all_admin();
	...
	{
		$data['query']=$this->admin_model->list_all_member();
		$this->load->view('template/header');
	...
	{
		$this->load->view('template/header');
		$this->load->view('backend/member_form_add' , array('error' => ' ' ));
		$this->load->view('template/footer');
	}
 ...
 public function Memberadding()
 {
	...
	public function editM($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('backend/member_form_edit',$data);
		$this->load->view('template/footer');
	}
  ...
  public function pwd($id)
	{
	  ...
	  public function Mpwd($id)
	{
		$data['rsedit']=$this->admin_model->read($id);
		$this->load->view('template/header');
		$this->load->view('backend/member_form_edit_pwd',$data);
		$this->load->view('template/footer');
	}
