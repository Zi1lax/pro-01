                ...
                <div class="col-sm-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <!-- form start -->
                            <form role="form" action="<?= site_url('member/editdataM'); ?>" method="post" class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" name="admin_phone" class="form-control" required placeholder="เบอร์โทร ขั้นต่ำ 4 ตัว" value="<?= $rsedit->admin_phone; ?>" minlength="4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <select name="admin_status" readonly class="form-control">
                                                <span class="fr"><?= form_error('admin_status'); ?></span>
                                                <option value="<?= $rsedit->admin_status;?>">
                                                    <?php if($rsedit->admin_status==2){echo 'สมาชิก';}?>  </option>
