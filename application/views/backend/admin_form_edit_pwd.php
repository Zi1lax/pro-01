                            ...
                            <form role="form" action="<?= site_url('admin/editpwd'); ?>" method="post" class="form-horizontal">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="password" name="admin_pwd2" class="form-control" required placeholder="ภาษาอังกฤษ/ตัวเลข/ขั้นต่ำ 2 ตัว"  minlength="2"  value="<?= set_value('admin_pwd'); ?>"  title="ภาษาอังกฤษหรือตัวเลขเท่านั้น">
