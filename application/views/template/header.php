...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php //echo $mylink;?>" class="logo">
      ...
      <span class="logo-lg">
      <img src="/helpdesk2/images/PBRU-logo.png" alt="PBRU Logo" style="height:50px; margin-right:10px;">
        <b>A</b>dmin
      </span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo site_url('admin/edit/'.$_SESSION['id']);?>" class="btn btn-primary btn-flat">Profile</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">MAIN NAVIGATION</li>
           <li><a href="<?= site_url('jobs');?>"><i class="fa fa-home"></i> <span>หน้าหลัก</span></a></li>
           <li><a href="<?= site_url('jobs');?>"><i class="fa fa-list"></i> <span>งานซ่อม</span></a></li>
           <li><a href="<?= site_url('report');?>"><i class="fa fa-signal"></i> <span>Dashboard</span></a></li>
           <li><a href="<?= site_url('admin');?>"><i class="fa fa-user"></i> <span>จัดการข้อมูล Admin</span></a></li>
           <li><a href="<?= site_url('admin/member');?>"><i class="fa fa-users"></i> <span>จัดการข้อมูล สมาชิก</span></a></li>
           <li><a href="<?= site_url('device');?>"><i class="fa fa-gear"></i> <span>จัดการข้อมูล อุปกรณ์</span></a></li>
